  ...
  return <div className="space-y-8">
      ...
      <div className="space-y-3">
        ...
        <p className="text-sm md:text-base text-[#1c1c1c] opacity-75 mt-3">
          Inserisci i tuoi dati di contatto per ricevere la stima personalizzata. I nostri algoritmi analizzano le specifiche del tuo progetto e i dati di mercato per generare una valutazione accurata e immediata.
        </p>
      </div>
