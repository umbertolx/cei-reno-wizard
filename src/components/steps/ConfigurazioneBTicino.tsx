        ...
        <div className="max-w-4xl md:mx-auto space-y-6 md:space-y-8 mt-8 md:mt-16">
          <div className="space-y-4 md:space-y-6">
            ...
            <div className="flex items-center gap-4 px-3 md:px-0">
              ...
              <div>
                <h2 className="text-xl md:text-2xl font-medium text-[#1c1c1c]">Configurazione BTicino Wireless</h2>
                <p className="text-base text-[#1c1c1c] opacity-80">
                  Personalizza le funzionalità del tuo impianto domotico wireless
                </p>
              </div>
            </div>
