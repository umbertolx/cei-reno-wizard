...
export const WelcomePage = ({
  ...
  return <div className="space-y-4">
      ...
      <div className="space-y-2 md:space-y-3">
        <h1 className="text-3xl md:text-4xl font-bold text-[#1c1c1c] leading-tight text-left md:text-center p-1">
      ...
      <div className="max-w-4xl md:mx-auto">
        <div className="mb-4 md:mb-6 text-left md:text-center">
          <h2 className="text-3xl md:text-4xl font-bold text-[#1c1c1c] leading-tight mb-1 md:mb-2 p-1">Seleziona gli impianti:</h2>
