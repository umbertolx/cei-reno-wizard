...
import { ElectricalConfiguration } from "./steps/3-electrical/01-ElectricalConfiguration/ElectricalConfiguration";
import { ElectricalSystemAge } from "./steps/3-electrical/07-ElectricalSystemAge/ElectricalSystemAge";
import { ElectricalInterventions } from "./steps/3-electrical/08-ElectricalInterventions/ElectricalInterventions";
import { RoomSelection } from "./steps/3-electrical/09-RoomSelection/RoomSelection";
import { ElectricalSystemType } from "./steps/3-electrical/02-ElectricalSystemType/ElectricalSystemType";
import { TipoDomotica } from "./steps/3-electrical/04-TipoDomotica/TipoDomotica";
import { ConfigurazioneKNX } from "./steps/3-electrical/05-ConfigurazioneKNX/ConfigurazioneKNX";
import { ConfigurazioneBTicino } from "./steps/3-electrical/06-ConfigurazioneBTicino/ConfigurazioneBTicino";
import { ElectricShutters } from "./steps/3-electrical/03-ElectricShutters/ElectricShutters";
