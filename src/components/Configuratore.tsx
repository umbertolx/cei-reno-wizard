...
import { WelcomePage } from "./steps/01-welcome/WelcomePage";
import { GeneralInformation } from "./steps/02-general/GeneralInformation";
import { ElectricalConfiguration } from "./steps/03-electrical/ElectricalConfiguration";
import { ElectricalSystemAge } from "./steps/03-electrical/ElectricalSystemAge";
import { ElectricalInterventions } from "./steps/03-electrical/ElectricalInterventions";
import { RoomSelection } from "./steps/03-electrical/RoomSelection";
import { ElectricalSystemType } from "./steps/03-electrical/ElectricalSystemType";
import { TipoDomotica } from "./steps/03-electrical/TipoDomotica";
import { ConfigurazioneKNX } from "./steps/03-electrical/ConfigurazioneKNX";
import { ConfigurazioneBTicino } from "./steps/03-electrical/ConfigurazioneBTicino";
import { ElectricShutters } from "./steps/03-electrical/ElectricShutters";
import { PhotovoltaicInterventionType } from "./steps/07-photovoltaic/PhotovoltaicInterventionType";
import { RoofCharacteristics } from "./steps/07-photovoltaic/RoofCharacteristics";
import { ConsumptionGoals } from "./steps/07-photovoltaic/ConsumptionGoals";
import { ExpansionGoals } from "./steps/07-photovoltaic/ExpansionGoals";
import { DettagliImpiantoEsistente } from "./steps/07-photovoltaic/DettagliImpiantoEsistente";
import { ConsumiAnnui } from "./steps/07-photovoltaic/ConsumiAnnui";
import NuoveVociConsumo from "./steps/07-photovoltaic/NuoveVociConsumo";
import { DefinizioneConsumiStandard } from "./steps/07-photovoltaic/DefinizioneConsumiStandard";
import { DisponibilitaSuperficieTetto } from "./steps/07-photovoltaic/DisponibilitaSuperficieTetto";
import { BatteriaAccumulo } from "./steps/07-photovoltaic/BatteriaAccumulo";
import { RequestSent } from "./steps/15-final/RequestSent";
import { DatiContatto } from "./steps/15-final/DatiContatto";
import { StimaFinale } from "./steps/15-final/StimaFinale";
